...
![Logo]( <img src="logo.png" width="350" alt="hi" class="inline"/>)
...
- модели получены, обучены, результаты есть в репозиториях

##### Что сделать легко и приятно
- добавить другие вариации VGG + что-то, например, Unet
