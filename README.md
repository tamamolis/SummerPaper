...
- попробовать скомбинировать какой-то классический метод и нейросетку. например:
  - получить сегментацию из классического метода
  - получить границы из засегментированного классического метода
  - наложить их, глянуть что выйдет. у [немцев](https://arxiv.org/pdf/1612.01337v1.pdf) похожее
...
- постобработка, конкретно CRF __DONE__
- boundary detection, прочитать у [немцев](https://arxiv.org/pdf/1612.01337v1.pdf) __DONE__
